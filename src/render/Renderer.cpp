// #include "Renderer.h"
//
// void NRenderBuffer::draw(sf::RenderWindow& window) {
// 	texture.display();
...
//
// 	sprite.setScale(NWindow::viewport.scale); // because the coords of sf::RenderTexture are flipped, y=0 is below
// 	sprite.setPosition(NWindow::viewport.offset);
