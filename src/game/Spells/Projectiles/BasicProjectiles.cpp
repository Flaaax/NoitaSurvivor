...
namespace flx::game {
	myecs::entity BulletSpell::createProjectile(const GameCtx& ctx, vec2 worldPos, vec2 dir) {
	...
	myecs::entity ExplosionSpell::createProjectile(const GameCtx& ctx, vec2 worldPos, vec2 dir) {
