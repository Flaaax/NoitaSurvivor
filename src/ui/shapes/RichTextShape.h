...
namespace flx::ui {
	class RichTextShape : public sf::Drawable, public sf::Transformable {
	protected:
		...
		mutable Vector<text::TextRun> m_runs;
		mutable Vector<sf::Vertex> m_vertices;
		mutable Vector<sf::Vertex> m_outlineVertices;
